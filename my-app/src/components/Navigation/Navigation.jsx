...
const Navigation = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(`http://localhost:8081/api/products/search?keyword=${searchTerm}`);
      navigate("/search", { state: { products: response.data, query: searchTerm } });
