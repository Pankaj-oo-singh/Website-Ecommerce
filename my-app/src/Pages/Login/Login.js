...
//       const token = res.accessToken; // ✅ FIXED HERE
//       saveToken(token);
//       console.log(token);
...
//         alert("Token already expired. Please login again.");
...
const Login = () => {
  ...
  const handleGoogleLogin = (response) => {
    ...
    // Send the Google credential to your backend API for validation
    console.log('Google login success:', credential);
    // Call your API to log in with the Google credential
    // You can use the credential to authenticate and save the token as you did with the regular login
  };
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
            <GoogleSignIn/> {/* ✅ Replaces the old dummy Google button */}
           </div>
          </div>
        </div>
      </div>
