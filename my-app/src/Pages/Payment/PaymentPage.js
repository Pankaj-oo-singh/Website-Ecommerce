...
//   // State to hold user address data
...
//         const address = user.addressList && user.addressList[0]; // If there are multiple, choose the first one for now
//         setUserAddress(address);

//         // Populate form data with address
//         setFormData((prev) => ({
//           ...prev,
//           firstName: user.firstName || '',
//           lastName: user.lastName || '',
//           email: user.email || '',
//           phone: address?.phoneNumber || '', // Use address's phone if available
//           address: address?.street || '',
//           city: address?.city || '',
//           zipCode: address?.zipCode || '',
//           country: address?.state || '', // Using 'state' as country for now
//         }));
//       } catch (error) {
...
//     // Here, send order + address + paymentMethod to your backend.
//     console.log('Order & Address Info:', formData);
...
//       <h2 className="text-3xl font-bold mb-6 text-gray-800">Delivery & Payment</h2>
...
//     if (formData.paymentMethod.toLowerCase() === 'card') {
//       const { cardName, cardNumber, expiryDate, cvv } = formData;
//       if (!cardName || !cardNumber || !expiryDate || !cvv) {
//         alert('Please fill in all card details.');
//         return;
...
//             className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-md font-medium"
//           >
//             {formData.paymentMethod === 'card' ? 'Proceed to Pay' : 'Confirm Order'}
//           </button>
//         </div>
//       </form>
//     </div>
