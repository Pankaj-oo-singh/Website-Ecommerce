...
//                   className={`py-2 pl-10 block w-full border ${errors.name ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500`}
//                 />
//               </div>
//               {errors.name && (
...
//                   onChange={handleChange}
//                   className={`py-2 pl-10 block w-full border ${errors.confirmPassword ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500`}
//                 />
//               </div>
...
// // Permissions will be derived automatically based on role
// const getPermissionsForRole = (role) => {
//   switch (role) {
//     case "USER":
//       return ["USER_VIEW"];
//     case "CREATOR":
//       return ["USER_VIEW", "CREATE_CONTENT"];
//     case "ADMIN":
//       return ["USER_VIEW", "USER_MANAGE", "ADMIN_PANEL_ACCESS"];
//     default:
//       return [];
//   }
// };
